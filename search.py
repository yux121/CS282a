...
def load_codebase(code_path, chunk_size=2000000):
    ...
    codebase= []
    codes = codecs.open(code_path, encoding='latin-1').readlines()[:2000000] # use codecs to read in case of encoding problem
...
if __name__ == '__main__':
    ...
    ckpt=f'./output/{args.model}/{args.dataset}/models/code_nl_aug/step{args.reload_from}.h5'
